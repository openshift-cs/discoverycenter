...
select `jboss-eap64-openshift:1.3` and fill in the form like this
...
[source]
----
oc new-app --name=myapp jboss-eap64-openshift~https://github.com/[your user name]/os-sample-java-web.git
----
